...
// Function prototypes
void inputProcesses(int n, int proc_id[], int p[], int at[], int bt[], int m[], int rt[]);
void sortProcesses(int proc_id[], int p[], int at[], int bt[], int n);
void calculateCompletionTime(int n, int proc_id[], int p[], int at[], int bt[], int ct[], int m[], int rt[]);
...
int main() {
    ...
    inputProcesses(n, proc_id, p, at, bt, m, rt);

    // Sort processes based on priority
    sortProcesses(proc_id, p, at, bt, n);

    // Calculate completion time
    calculateCompletionTime(n, proc_id, p, at, bt, ct, m, rt);
